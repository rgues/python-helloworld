...
@Component({
  ...
  templateUrl: './approved-user.page.html',
  styleUrls: ['./approved-user.page.scss'],
})
export class ApprovedUserPage implements OnInit {
  ...
  getDebtsApproved(event) {
    ...
    this.debt.getMembreBillComplete(param).subscribe((reponse: any) => {
