...
@Component({
  ...
  templateUrl: './in-approval-user.page.html',
  styleUrls: ['./in-approval-user.page.scss'],
})
export class InApprovalUserPage implements OnInit {
  ...
  getDebtsInApproval(event) {
    ...
    this.debt.getMembreBillInapproval(param).subscribe((reponse: any) => {
