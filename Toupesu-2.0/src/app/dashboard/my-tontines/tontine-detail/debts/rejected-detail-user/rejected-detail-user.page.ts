...
@Component({
  ...
  templateUrl: './rejected-detail-user.page.html',
  styleUrls: ['./rejected-detail-user.page.scss'],
})
export class RejectedDetailUserPage implements OnInit {
  ...
  deleteProf(proof) {
    ...
    this.debt.deleteProofRejetected(data).subscribe((reponse: any) => {
